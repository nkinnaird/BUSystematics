...
\begin{tabularx}{0.7\linewidth}{XOOOO}
  ...
  \hline
\end{tabularx}
\caption[]{Results for pileup amplitude multiplier scans for the four Run~1 datasets for both fit methods. Included are the sensitivities of \R to the pileup multiplier, uncertainties on the amplitude as determined from the widths of the \chisq parabolas, and the pileup multipliers for which the \chisq was a minimum. The sensitivities are in units of ppb per unit multiplier (or just ppb), and the rest of the quantities are unit-less.}
